...
> **この文書は配布物作成時点の試験記録です。**現在のリポジトリの状態ではありません。
> 本書の件数・環境・数値は当時のものとして保存し、更新しません。
>
> 現在の状態は次を参照してください。
>
> - 実行方法と経路ごとの保証範囲: `README.md`
> - 本環境での受け入れ結果と修正記録: `docs/local_setup_notes.md`
> - 実測した段階別レイテンシと判定: `docs/performance_results.md`
> - 参考実装の採否と通信方式の比較条件: `docs/performance_design.md`
